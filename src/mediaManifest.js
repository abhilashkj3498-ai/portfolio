// Category definitions — slugs MUST match the exact Cloudinary folder names
// under portfolio/images/<slug>
//
// If you rename a folder in Cloudinary, update the slug here to match.
